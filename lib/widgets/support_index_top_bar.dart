...
///材料设计[AppBar]中展开和折叠的部分。
///
///最常用于[SLVRAPPARB.FraciWorkStay]字段，灵活的
///当应用程序滚动时，空格键会展开和收缩，以便[AppBar]
///从应用程序顶部到达
///应用程序。
///
///调整[AppBar]大小的小部件必须将其包装在由返回的小部件中
///[灵活的PaaBea.CurreSeTeStices ]，将大小信息传送到
///[灵活的计程仪]。
///
///另见：
///
///*[SliverAppBar]，它实现了扩展和收缩。
///*[AppBar]，由[SliverAppBar]使用。
///*<https://material.io/design/components/app bars top.html#行为>
/// 自定义运动首页顶部
class SupportIndexTopBar extends StatefulWidget {
  /// Creates a flexible space bar.
  ///
  /// Most commonly used in the [AppBar.flexibleSpace] field.
  const SupportIndexTopBar({
    Key key,
    this.title,
    this.background,
    this.centerTitle,
  ...
  @override
  _SupportIndexTopBarState createState() => _SupportIndexTopBarState();
}

class _SupportIndexTopBarState extends State<SupportIndexTopBar> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (renderBoxRed != null) _offset = renderBoxRed.size.width / 2;
    });
    super.initState();
  }
...
//        double width = (size.width ) / 2 - _offset;
