...
class Colours {
  ...
  static const Color btn_text = Color(0xFF3C7DF9);
  static const Color task_pro1 = Color(0xFF4aeff2);
  static const Color task_pro2 = Color(0xFF4af2e7);
  static const Color task_pro3 = Color(0xFF4af2cb);
  static const Color task_pro4 = Color(0xFF4af2bd);
  static const Color task_pro5 = Color(0xFF4af2af);
  static const Color task_pro6 = Color(0xFF4af2a1);
  static const Color task_pro6d = Color(0xFF91f7e0);

  static const List<Color> task_pro = [
    task_pro1
    ,task_pro2
    ,task_pro3
//    ,task_pro4
